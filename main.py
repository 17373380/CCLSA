...
if __name__ == '__main__':
    ...
    parse.add_argument('-cap_loss_alpha', type=int, default=1, help='')
    ...
    if opt.data_type == 'HFM':
        ...
        data_caption_path = data_path_root + 'caption.json'
    else:
        ...
        data_caption_path = abl_path + 'dataset/data/' + opt.data_type + '/' + 'caption.json'
    ...
    train_loader, opt.train_data_len = data_process.data_process(opt, train_data_path, tokenizer, photo_path, data_type=1, data_translation_path=data_translation_path,
                                                                 data_caption_path=data_caption_path, image_coordinate=image_coordinate)
    ...
    if opt.run_type == 1:
        ...
        print('\nTest Begin')
        model_path = "/home/yaobowen/CLMLF-main/checkpoint/2023-11-10-10-04-50-MVSA-single-3-att-256-2-bert-base-/11-10-10-41-44-Acc-0.75778.pth"
